import dictionary from './dict-index'
const replaceString = (str, find, replace) => (find === '' ? str : str.split(find).join(replace))

export default function convertKrutiDev(_text) {
  let text = _text
